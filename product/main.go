...
import (
	...
	"go-micro/product/common"
	"go-micro/product/domain/repository"
	service2 "go-micro/product/domain/service"
	"go-micro/product/handler"

	_ "github.com/jinzhu/gorm/dialects/mysql"
	consul2 "github.com/micro/go-plugins/registry/consul/v2"

	"github.com/micro/go-micro/v2"
	product "go-micro/product/proto/product"
)
